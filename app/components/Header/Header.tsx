...
export const Header = () => {
    ...
    const handleIndicator = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, href: string) => {
    ...
    return (
        <header className={`${styles.header} d-flex align-items-center`}>
            <nav className={styles.navBar}>
                <ul className={`d-flex`}>
                    <div className={styles.marker} style={{ left: markerStyle.left, width: markerStyle.width }}></div>
                    ...
                    <li>
                        ...
                        >
                            <span className={styles.text}><FaHouse /></span>
                        </Link>
                    </li>
                    ...
                    <li>
                        <Link
                            ...
                            href='/portfolio'
                            onClick={(e) => handleIndicator(e, '/portfolio')}
                        >
                    ...
                    <li>
                        <Link
                            ...
                            href='/projects'
                            onClick={(e) => handleIndicator(e, '/projects')}
                        >
                    ...
                    <li>
                        <Link
                            ...
                            href='/cv'
                            onClick={(e) => handleIndicator(e, '/cv')}
                        >
                    ...
                    <li>
                        <Link
                            ...
                            href='/contacts'
                            onClick={(e) => handleIndicator(e, '/contacts')}
                        >
